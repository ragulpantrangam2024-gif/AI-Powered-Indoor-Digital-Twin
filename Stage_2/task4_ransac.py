...
# Save and Display
# -------------------------------------
cv2.imshow("RANSAC Inlier Matches", matched_image)

cv2.imwrite(r"D:\rwu\rwu jobs\TwinCube\Stage_2\results\ransac_matches.jpg", matched_image)
...
print("RANSAC Inliers:", np.sum(mask))
print("RANSAC Outliers:", len(good_matches) - np.sum(mask))
